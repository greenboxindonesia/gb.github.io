<?php
/*
* Archive Demo Website Base
* Author: Albert Sukmono
* Description: Archive Template Plugin "boxlink" for view content post projectbase
*/
                ...
                <header class="page-title">
                    <h2><?php
                        if (is_day()) {
                            ...
                            _e('Arsip Projectbase', 'bootstrapwp');
                        }
                        ?></h2>
                </header>
                <?php
                        ...
                        <div class="row">
                            ...
                            if ( bootstrapwp_autoset_featured_img() !== false ) : ?>
                                <div class="span2">
									...
									<img style="width:150px;height:150px;" src="<?php bloginfo('template_directory'); ?>/assets/img/no-image-thumb.svg" alt="<?php the_title(); ?>" />
									<?php } ?>
									</a>
									</div>
                                </div>
